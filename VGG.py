...
def VGG16N(x, n_classes, is_pretrain=True):
    with tf.name_scope('VGG16'):
        ...
        x = tools.conv('conv3_1', x, 128, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
        x = tools.conv('conv3_2', x, 128, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
        ...
        x = tools.conv('conv4_1', x, 128, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
        x = tools.conv('conv4_2', x, 128, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
        x = tools.conv('conv4_3', x, 128, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
        ...
        x = tools.FC_layer('fc1', x, out_nodes=1000)
        x = tools.FC_layer('fc2', x, out_nodes=n_classes)
